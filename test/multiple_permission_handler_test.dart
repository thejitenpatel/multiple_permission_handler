...
void main() {
  final MultiplePermissionHandlerPlatform initialPlatform = MultiplePermissionHandlerPlatform.instance;

  test('$MethodChannelMultiplePermissionHandler is the default instance', () {
    expect(initialPlatform, isInstanceOf<MethodChannelMultiplePermissionHandler>());
  });

  test('getPlatformVersion', () async {
    MultiplePermissionHandler multiplePermissionHandlerPlugin = MultiplePermissionHandler();
    MockMultiplePermissionHandlerPlatform fakePlatform = MockMultiplePermissionHandlerPlatform();
